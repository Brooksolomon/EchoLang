...
namespace EchoLang
{
    ...
    public class theme
    {
        public static Color MAINPANELBACKGROUND = Color.FromArgb(255, 46, 51, 73);
        public static Point MAINPANELPOINT = new Point(210, 0);
        public static Size MAINPANELSIZE = new Size(800, 2000);
        public static Color BUTTONBACKCOLOR = Color.GreenYellow;
        ...
        public static Panel GenerateUserCard(string name, string username, int x, int y)
        {

            Guna2Panel panel = new Guna2Panel();
            panel.FillColor = Color.FromArgb(255, 68, 207, 203);
            ...
            userlabel.Location = new Point(30, 40);
